...
function IntakeContent() {
  ...
  // Get optional ref code from URL
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-6 sm:p-8">
            ...
            <p className="text-gray-600 dark:text-white/70 mb-6">
              Enter your details below to begin. Your personalized report will be prepared by our team after you complete the assessment.
            </p>

            {error && (
              <div className="mb-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/30 rounded-lg text-red-800 dark:text-red-400 text-sm">
                {error}
              </div>
            )}
